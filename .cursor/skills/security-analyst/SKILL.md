...
description: >
  Expert in securing REST APIs and ActivityPub/fediverse systems. Analyzes plans and code
  for security vulnerabilities. Use when reviewing security of APIs, federation, auth,
  visibility, or access control; when the user asks for a security review; or when
  implementing auth, authorization, visibility, or block handling.
---
