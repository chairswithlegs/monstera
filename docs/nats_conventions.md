...
> For full implementation details see [architecture/07-activitypub-and-federation.md](architecture/07-activitypub-and-federation.md) (federation) and [architecture/09-sse-streaming-and-nats.md](architecture/09-sse-streaming-and-nats.md) (SSE streaming).
