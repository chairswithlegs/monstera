...
CREATE TABLE accounts (
    ...
    followers_count INT NOT NULL DEFAULT 0,     -- denormalized (ADR 08)
    following_count INT NOT NULL DEFAULT 0,
    statuses_count  INT NOT NULL DEFAULT 0,
    fields          JSONB,                      -- profile metadata fields (ADR 08)
...
CREATE TABLE users (
    ...
    default_privacy TEXT NOT NULL DEFAULT 'public',   -- (ADR 08)
...
CREATE TABLE statuses (
    ...
    in_reply_to_account_id TEXT REFERENCES accounts(id), -- (ADR 08)
