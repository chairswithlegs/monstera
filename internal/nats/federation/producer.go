...
// DeliveryMessage is the payload published to the FEDERATION stream.
...
func (p *Producer) EnqueueDelivery(ctx context.Context, activityType string, msg DeliveryMessage) error {
