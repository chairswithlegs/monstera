...
type mockAccountService struct {
	...
	GetByIDFunc                     func(ctx context.Context, id string) (*domain.Account, error)
	CreateFunc                      func(ctx context.Context, in service.CreateAccountInput) (*domain.Account, error)
	GetLocalByUsernameFunc          func(ctx context.Context, username string) (*domain.Account, error)
...
func (m *mockAccountService) GetLocalByUsername(ctx context.Context, username string) (*domain.Account, error) {
	return m.GetLocalByUsernameFunc(ctx, username)
}

func (m *mockAccountService) GetByUsername(ctx context.Context, username string, accountDomain *string) (*domain.Account, error) {
	return m.GetByUsernameFunc(ctx, username, accountDomain)
}
