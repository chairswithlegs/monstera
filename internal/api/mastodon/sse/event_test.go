...
func TestStreamKeyToSubject(t *testing.T) {
	...
	tests := []struct {
		...
		{"user notification", StreamUserNotificationPrefix + "acc123", SubjectPrefixUserNotification + "acc123"},
...
func TestSubjectToStreamKey(t *testing.T) {
	...
	tests := []struct {
		...
		{"user notification", SubjectPrefixUserNotification + "acc123", StreamUserNotificationPrefix + "acc123"},
...
func TestStreamKeyMetricLabel(t *testing.T) {
	...
	tests := []struct {
		...
		{"user notification", StreamUserNotificationPrefix + "acc123", "user:notification"},
