...
func NewNotificationsHandler(notifications *service.NotificationService, accounts *service.AccountService, logger *slog.Logger, instanceDomain string) *NotificationsHandler {
...
func (h *NotificationsHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	for i := range list {
		...
		out = append(out, apimodel.ToNotification(n, fromAcc, nil, h.domain))
	}
