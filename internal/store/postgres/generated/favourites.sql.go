...
INSERT INTO favourites (id, account_id, status_id) VALUES ($1, $2, $3) RETURNING id, account_id, status_id, created_at, ap_id
`
...
func (q *Queries) CreateFavourite(ctx context.Context, arg CreateFavouriteParams) (Favourite, error) {
	row := q.db.QueryRow(ctx, createFavourite, arg.ID, arg.AccountID, arg.StatusID)
	var i Favourite
	err := row.Scan(
		&i.ID,
		&i.AccountID,
