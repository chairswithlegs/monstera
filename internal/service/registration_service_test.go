...
func TestRegistrationService_Confirm(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		svc := NewRegistrationService(fake, nil, nil, "https://example.com", "Example")
...
func TestRegistrationService_Approve(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		svc := NewRegistrationService(fake, mailer, nil, "https://example.com", "Example")
...
func TestRegistrationService_Reject(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		svc := NewRegistrationService(fake, nil, mailer, "https://example.com", "Example")
